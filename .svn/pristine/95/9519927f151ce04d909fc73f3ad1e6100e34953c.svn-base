...
class TeegonService {
    ...
    function pay($param,$result_decode = true){
        ...
        $param['client_secret'] = C("TEE_PAY.TEE_CLIENT_SECRET");
    ...
    public function get_sign_veryfy($para_temp, $sign){
        ...
        $isSgin = $this->md5_verify($prestr, $sign, C("TEE_PAY.TEE_CLIENT_SECRET"));
    ...
    public function sign($para_temp){
        ...
        $prestr = C("TEE_PAY.TEE_CLIENT_SECRET").$prestr . C("TEE_PAY.TEE_CLIENT_SECRET");
